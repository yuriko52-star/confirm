...
@section('css')
<link rel="stylesheet" href="{{ asset('css/confirm.css') }}" class="">
        ...
        <form action="/thanks" method="post">
          ...
          <table class="confirm-form__table">
           ...
           <div class="confirm-form__btn-inner">
                ...
                <input type="submit" class="confirm-form__send-btn btn" value="送信"name="send">
                <input type="submit" class="confirm-form__back-btn"value="修正" name="back">
